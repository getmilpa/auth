...
/**
 * This file is part of milpa/auth — the runtime-native identity vocabulary of the Milpa PHP
 * framework.
 *
...
/**
 * Generates the static API reference site for milpa/auth.
 *
 ...
 * milpa/auth carries no milpa/* runtime dependency): reflects over `src/`,
 * renders one `mui-api`-styled page per public type wrapped in the `mui-docs`
 * shell, a nav, a per-page table of contents, and `index.html`.
 *
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Auth',
    nsPrefix: 'Milpa\\Auth\\',
    installCommand: 'composer require milpa/auth',
    repoUrl: 'https://github.com/getmilpa/auth',
